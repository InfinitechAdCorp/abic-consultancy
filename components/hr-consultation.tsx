...
const serviceOptions = [
  {
    value: "recruitment-talent",
    label: "Recruitment & Talent Strategy",
    icon: Users,
  ...
  },
  {
    ...
    label: "Employee Performance & Retention",
    icon: TrendingUp,
  ...
  {
    value: "hr-technology",
    label: "HR Technology & Process Optimization",
    icon: Settings,
  ...
  },
  {
    ...
    label: "Workforce Training & Development",
    icon: GraduationCap,
  ...
  },
  {
    ...
    description: "Custom HR solutions tailored to your needs",
  },
]
...
export default function HRConsultation() {
  ...
  const fetchTimeSlotAvailability = async (date: string) => {
    try {
      ...
      const response = await fetch(`/api/hr-consultation/time-slots?date=${date}`)
  ...
  const validateForm = () => {
    ...
    if (!formData.serviceType) newErrors.serviceType = "Please select an HR service"
    if (formData.serviceType === "other" && !formData.otherServiceDetails.trim()) {
      newErrors.otherServiceDetails = "Please describe the HR service you need"
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("/api/hr-consultation", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          other_service_details: formData.otherServiceDetails,
      ...
      if (!response.ok) {
        if (response.status === 422 && result.errors) {
          // Show specific validation errors as toast notifications
          const errorMessages = []

          // Extract all error messages from the Laravel validation response
        ...
        throw new Error(result.message || "Failed to submit HR consultation")
      }
      ...
      toast({
        ...
        description:
          result.message ||
          "Your HR consultation request has been submitted successfully and email notifications sent!",
      })

      if (formData.preferredDate) {
        await fetchTimeSlotAvailability(formData.preferredDate)
      }
    ...
    <>
      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <Card className="bg-white shadow-2xl border-0 overflow-hidden">
          <div className="h-2 lg:h-3 bg-gradient-to-r from-blue-400 via-blue-500 to-green-600"></div>
          <CardHeader className="text-center pb-4 lg:pb-6 bg-gradient-to-r from-blue-50 to-green-50">
            ...
            <p className="text-gray-700 text-sm lg:text-base mt-2 px-4">
              We help businesses build and manage a high-performing workforce by providing expert HR consulting services
              tailored to your needs. Whether you're a startup or an established company, our HR solutions ensure
          ...
          <CardContent className="p-4 sm:p-6 lg:p-8">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 mb-6 lg:mb-8 bg-gray-100 p-1 lg:p-2 rounded-xl lg:rounded-2xl gap-1">
                <TabsTrigger
                  value="personal"
                  className="flex items-center gap-1 lg:gap-2 rounded-lg lg:rounded-xl data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-green-500 data-[state=active]:text-white transition-all duration-300 text-xs sm:text-sm"
                >
                ...
                >
                  ...
                  <span className="hidden sm:inline">HR Service</span>
                </TabsTrigger>
                <TabsTrigger
                  value="schedule"
                  className="flex items-center gap-1 lg:gap-2 rounded-lg lg:rounded-xl data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-green-500 data-[state=active]:text-white transition-all duration-300 text-xs sm:text-sm"
              ...
              <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-8">
                <TabsContent value="personal" className="space-y-6 lg:space-y-8">
                  ...
                  <div className="flex justify-end pt-4 lg:pt-6">
                    <Button
                      ...
                      className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 text-white px-6 lg:px-8 py-3 lg:py-4 text-base lg:text-lg font-semibold rounded-xl transform hover:scale-105 transition-all duration-300"
                    >
                ...
                <TabsContent value="service" className="space-y-6 lg:space-y-8">
                  <div className="space-y-4">
                    <Label className="text-lg lg:text-xl font-bold text-gray-800">
                      What HR service are you interested in? *
                    </Label>
                  ...
                  {/* Additional field for "Other HR Services" */}
                  {formData.serviceType === "other" && (
                    <div className="space-y-3 bg-gradient-to-r from-gray-50 to-green-50 p-4 lg:p-6 rounded-xl border-2 border-gray-200">
                      <Label htmlFor="otherServiceDetails" className="text-base lg:text-lg font-semibold text-gray-700">
                        Please describe the HR service you need *
                      </Label>
                      <Textarea
                        ...
                        placeholder="Please provide details about the specific HR service you're looking for..."
                        rows={4}
                      />
                      {errors.otherServiceDetails && (
                  ...
                  <div className="space-y-6 bg-gradient-to-r from-blue-50 to-green-50 p-4 lg:p-6 rounded-xl">
                ...
                <TabsContent value="schedule" className="space-y-6 lg:space-y-8">
                  ...
                  <div className="space-y-4 lg:space-y-6">
                    ...
                    <div className="flex items-center justify-between bg-gradient-to-r from-blue-50 to-green-50 p-3 lg:p-4 rounded-xl">
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                            ...
                            <Button
                              ...
                              className={`h-10 lg:h-12 flex flex-col items-center justify-center rounded-lg border-2 transition-all duration-300 transform hover:scale-105 text-xs lg:text-sm ${
                                formData.preferredDate === dateOption.date
                                  ? "bg-gradient-to-r from-blue-500 to-green-500 text-white border-transparent shadow-xl scale-105"
                                  : dateOption.isToday
                ...
                <TabsContent value="additional" className="space-y-6 lg:space-y-8">
                  <div className="space-y-4">
                    <Label htmlFor="message" className="text-lg lg:text-xl font-bold text-gray-800">
                      Tell us more about your HR needs (Optional)
                    </Label>
                    <Textarea
                      id="message"
                      value={formData.message}
                      onChange={(e) => handleInputChange("message", e.target.value)}
                      placeholder="Please describe your current HR challenges, workforce goals, specific questions, or any additional information that would help us prepare for your consultation..."
                      rows={6}
                  ...
                  <div className="space-y-4 lg:space-y-6 bg-gradient-to-r from-blue-50 to-green-50 p-4 lg:p-6 rounded-xl">
                    ...
                    <div className="flex items-start space-x-3 lg:space-x-4">
                      ...
                      >
                        Subscribe to our newsletter for HR tips and workforce management updates
                      </Label>
                    </div>
                  </div>
                  <div className="flex flex-col sm:flex-row justify-between gap-3 pt-4 lg:pt-6">
                    ...
                    <Button
                      ...
                      className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 text-white px-8 lg:px-12 py-3 lg:py-4 text-lg lg:text-xl font-bold rounded-xl transform hover:scale-105 transition-all duration-300 shadow-xl"
                    >
                      {isSubmitting ? (
