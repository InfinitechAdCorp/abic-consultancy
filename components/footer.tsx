        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              />
              <Button className="bg-white text-green-600 hover:bg-white-100 px-6 h-10 font-semibold text-sm">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-4">
              Your trusted partner for business success in the Philippines since 2018. We provide comprehensive consulting services to help you achieve your business goals.
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            <p className="text-gray-600 text-xs">
              © 2024 Advanced Beyond International Consulting Inc. All rights reserved.
            </p>
