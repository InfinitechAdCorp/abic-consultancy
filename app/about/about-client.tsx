...
import { Users, Target, Eye, Heart, Award, TrendingUp, Globe, ArrowRight } from "lucide-react"
...
export default function AboutPageClient() {
  ...
  const values = [
    ...
    },
    {
      ...
      title: "Collaboration",
      description:
        "We believe in the power of partnerships, fostering strong relationships with clients and stakeholders.",
    },
  ]
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative py-24 bg-gradient-to-br from-blue-100 via-green-100 to-purple-100 overflow-hidden">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-purple-400/20 to-orange-400/20 rounded-full blur-3xl animate-blob-fast"
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">Streamlining Your Business Needs Since 2018</p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div
              className={`grid lg:grid-cols-2 gap-12 items-center mb-16 transition-all duration-1000 ${isVisibleStory ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
              <div>
                <h2 className="text-3xl font-bold mb-6">Our Story</h2>
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Advanced Beyond International Consulting Inc. was officially established in September 2018, with its
                    headquarters in Makati, Philippines. The company was founded with the mission of assisting foreign
                    entrepreneurs and investors in establishing businesses and navigating the investment landscape in
                    the Philippines.
                  </p>
                  <p>
                    By providing comprehensive and efficient consulting services, we aim to streamline the setup process
                    and accelerate our clients' understanding of the local market, ensuring a smooth and successful
                    business establishment.
                  </p>
                </div>
              </div>
              <div className="relative">
                <div className="w-full h-80 bg-gradient-to-br from-green-200 to-blue-200 rounded-xl flex items-center justify-center shadow-lg transform group-hover:scale-105 transition-transform duration-300"></div>
                <div className="absolute top-0 left-0 right-0 bottom-0">
                  <img
                    src="/images/two_smiling.png"
            ...
            <div
              className={`grid md:grid-cols-2 gap-8 mb-16 transition-all duration-1000 ${isVisibleStory ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            ...
            >
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Empowering businesses and investors with strategic and innovative consulting solutions to thrive in
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    To be the premier bridge connecting foreign investors with thriving economic opportunities in the
                    Philippines.
                  </p>
                </CardContent>
              </Card>
      ...
      >
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div
              className={`text-center transition-all duration-1000 ${isVisibleValues ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-12">
            {stats.map((stat, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="bg-white/10 backdrop-blur border-white/20 text-white text-center transform hover:scale-105 transition-transform duration-300"
                >
                  <CardContent className="p-6">
