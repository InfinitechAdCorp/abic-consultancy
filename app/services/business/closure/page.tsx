      ...
      <section className="py-16 bg-gradient-to-br from-green-50 via-blue-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center text-gray-800">
            <h2 className="text-3xl font-bold mb-4">Need Help with Business Closure?</h2>
            <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
              Our experts will guide you through the entire closure process to ensure compliance and minimize complications
            </p>
