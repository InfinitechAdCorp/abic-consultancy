...
import { TrendingUp, TrendingDown, Users, FileText, DollarSign, Clock, Building2, Plane, Receipt, AlertCircle, CheckCircle, XCircle, Eye, Download, Plus, Menu } from 'lucide-react'
                        ...
                        <div key={app.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">{app.service} • {app.id}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-4">
